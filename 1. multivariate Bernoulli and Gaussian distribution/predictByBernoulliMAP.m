...
% provided probability vectors using Bernaulli Maximum Aposteriori Classifier
%
% Parameters
...
function [predictedLabels] = predictByBernoulliMAP(TestData, probVectorClass2, probVectorClass5, prior)
    ...
    for i = 1:numOfImages
        ...
        if imageProbVectorClass2(i)*prior >= imageProbVectorClass5(i)*(1-prior)
            predictedLabels(i) = 2;
        else
            predictedLabels(i) = 5;
        end
